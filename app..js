...
var collection = ["Ali", "Bilal", "Huzaifa"]
var target = prompt("Enter Yor Target to be search with  your indexOf method :")

function myIndexOf(collection, target) {
    for (var val = 0; val < collection.length; val++) {
        if (collection[val] === target) {
            alert("Your search has been found at index " + val)
            return val;

        }
    }
    alert("Your search has been not found")
    return -1;
}
...
/* PLEASE USE CHAPTER 43-48.HTML PAGE FOR RUNNING CHAPTER 43-48.JS FILE BEACUSE IT CONTAINS ADDITIONAL HTML */

/* ------- QUESTION 1 ------- */

// answer is inside the chapter 43-48.html page
...
/* PLEASE USE CHAPTER 49-52.HTML PAGE FOR RUNNING CHAPTER 49-52.JS FILE BEACUSE IT CONTAINS ADDITIONAL HTML  */
...
/*  PLEASE USE CHAPTER 53-58.HTML PAGE FOR RUNNING CHAPTER 53-58.JS FILE BEACUSE IT CONTAINS ADDITIONAL HTML */
...
/*PLEASE USE CHAPTER 58-67.HTML PAGE FOR RUNNING CHAPTER 58-67.JS FILE BEACUSE IT CONTAINS ADDITIONAL HTML */
...
console.log(y)
var y = document.getElementById("lastName").firstChild.nodeType;
console.log(y)


/* 2.3 */

var y = document.getElementById("lastName").firstChild = "Last Name = Peter";
...
console.log(element);
var element = document.getElementById("main-content").lastElementChild;
console.log(element);

/* 2.5 */

var y = document.getElementById("lastName").nextElementSibling;
console.log(y)
var y = document.getElementById("lastName").previousElementSibling;
console.log(y)
